...
<html lang="en">
    ...
    <title>Rejected JOs</title>
    <link rel="icon" href= "Images/sisc.png" type="image/x-icon"/>
    </head>

    <body>

    <!-- ###################### VIEW REJECT JOB ORDERS ######################## -->
    <div id="joreject1">
    <div class="modal1">
        <div class="modal-header">
            <h5 class="modal-title fs-5" id="exampleModalLabel">Job Order Details</h5>
            <button type="button" class="btn-close close-joreject1" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
            <form>
                ...
                <div class="contents-modal1">
                    <label for="jocomment" class="form-label">Comments:</label>
                    <textarea type="text" name="jocomment" id="jocomment" readonly></textarea>
                </div>
                <div class="contents-modal1">
                ...
                <div class="button-group" style="padding-bottom:0;">
                    <button type="button" class="btn close-joreject1" data-bs-dismiss="modal">Close</button>
                </div>
            </form>
        </div>
        </div>
...
<!-- ########################################################################################################################################### -->
    ...
    <div class="wrapper">
                ...
                <ul class="sidebar-nav">
                    ...
                    <li class="sidebar-item">
                        ...
                        <ul id="approvals" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar">
                            ...
                            <li class="sidebar-item">
                                <a href="#" onclick="location.href = 'joRejected.php'" class="sidebar-link" style="text-decoration: underline;">Rejected</a>
                            </li>
                        </ul>
                    </li>
                    <li class="sidebar-item">
        ...
        <div class="main">
            <nav class="navbar navbar-expand px-3 border-bottom">
                ...
                <div class="navbar-collapse">
                    <div class="page-title" style="align-items: center; font-size: 20px;">Rejected Job Orders
                    </div>
                        ...
                        <div class="filterForm">
                            ...
                            <select class="filterDate" id="year">
                                ...
                                if (isset($result[0])) {
                                    ...
                                    $query = "SELECT DISTINCT YEAR(dateFiled) AS year FROM rejectjotable";
                                ...
                                "columns": [
                                    ...
                                    { "data": "comments" },
                                    {
                                        ...
                                        "render": function (data, type, row, meta) {
                                            return '<button type="button" class="btn btn-success open-joreject1" data-rejectid="' + data + '" onclick="openModal(' + data + ')">View</button>';
                                        }
                                    }
                                ],
                                "paging": true,
        ...
        <script src="Javascript/viewRejectedJO.js"></script>
    </body>
</html>